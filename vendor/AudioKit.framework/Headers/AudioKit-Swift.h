...
+ (AKTuningTable * _Nonnull)tuningTable;
...
+ (BOOL)enableRouteChangeHandling;
...
*/
- (double)frequencyForNoteNumber:(uint8_t)noteNumber;
/**
...
*/
- (NSInteger)momentOfSymmetryWithGenerator:(double)gInput level:(NSInteger)lInput murchana:(NSInteger)mInput;
@end
...
/**
  From Erv Wilson.  See http://anaphoria.com/genus.pdf
*/
- (NSInteger)presetHighlandBagPipes;
/**
  From Erv Wilson.  See http://anaphoria.com/genus.pdf
*/
- (NSInteger)presetDiaphonicTetrachord;
@end
...
*/
- (NSArray<NSNumber *> * _Nullable)frequenciesFromScalaString:(NSString * _Nullable)rawStr;
@end
